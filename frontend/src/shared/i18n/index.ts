...
import viDisposal from './locales/vi/disposal.json';
...
import enDisposal from './locales/en/disposal.json';
...
i18n
  ...
  .init({
    ...
    defaultNS: 'common',
    ns: ['common', 'auth', 'catalogs', 'assets', 'imports', 'documents', 'handover', 'recovery', 'disposal', 'dashboard'],
    detection: {
